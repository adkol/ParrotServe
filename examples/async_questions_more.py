...
def Passage8(question:P.Input, response: P.Output):
    ...
    """
@P.semantic_function(formatter=P.allowing_newline)
def Passage9(question:P.Input, response: P.Output):
    """Role: You are a high school student answering questions for an english class. Read the passage below and answer the subsequent question.
...
async def do():
    global end
    prefix_choices = [Passage1, Passage2, Passage3, Passage4, Passage5, Passage6, Passage7, Passage8, Passage9]
    question_bank = []
    ...
    for x in range(NUM_SAMPLES):
        def thing(ind):
            ...
            prefix = prefix_choices[ind % len(prefix_choices)]
